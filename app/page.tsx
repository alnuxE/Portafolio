      ...
      <main className="max-w-4xl mx-auto px-4 md:px-6 py-12 md:py-20 flex flex-col gap-16 md:gap-24 relative z-10">
        ...
        <footer className="mt-16 border-t border-[var(--border-line)] pt-10 pb-8 flex flex-col md:flex-row items-center justify-between gap-6 opacity-0-init animate-fade-in-up delay-400 transition-colors duration-300">
          ...
          <div className="flex gap-6">
            <a href="https://www.linkedin.com/in/daniel-alejandro-estrada-olalde-532a16233/" className="flex items-center gap-2 text-[var(--text-page)]/70 hover:text-[var(--accent)] transition-colors font-medium">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" /></svg>
              LinkedIn
            </a>
            <a href="https://github.com/alnuxE" className="flex items-center gap-2 text-[var(--text-page)]/70 hover:text-[var(--accent)] transition-colors font-medium">
            ...
            <a href="mailto:danyolalde@gmail.com" className="flex items-center gap-2 text-[var(--text-page)]/70 hover:text-[var(--accent)] transition-colors font-medium">
